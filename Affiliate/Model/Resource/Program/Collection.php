<?php
class HN_Affiliate_Model_Resource_Program_Collection extends Mage_Rule_Model_Resource_Rule_Collection_Abstract
{
	/**
	...
	protected $_associatedEntitiesMap = array(
			'website' => array(
					'associations_table' => 'affiliate/website',
					'rule_id_field'      => 'rule_id',
					'entity_id_field'    => 'website_id'
			),
			'customer_group' => array(
					'associations_table' => 'affiliate/customer_group',
					'rule_id_field'      => 'rule_id',
	...
	*/
	protected function _construct()
	{
		...
		$this->_map['fields']['rule_id'] = 'main_table.program_id';
	}
